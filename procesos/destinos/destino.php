...
<div class="container text-center" style="border: 1px #000;">
  ...
  $q="select * from destinos ";
  $r=mysqli_query($con, $q);
 
  while( $datos=mysqli_fetch_array($r)){
    echo("<tr>");
    echo("<td scope='row'> <a href='destino2.php?id_destino=".$datos['id_destino']."&funcion=M' ><img src='../../img/dibujo (1).png' alt='' ></a>
  ...
  <a href='destino2.php?id_destino=0&funcion=A' ><img src='../../img/pluss.png ' class="m-2" height="50px" ></a>
  </table>
</body>
<?php
require "../../php/pie.php";
