...
<div class="container text-center" style="border: 1px #000;">
  ...
  while( $datos=mysqli_fetch_array($r)){
    echo("<tr>");
    echo("<td scope='row'> <a href='marca2.php?id_marca=".$datos['id_marca']."&funcion=M' ><img src='../../img/dibujo (1).png' alt='' ></a>
  
  <a href='marca2.php?id_marca=".$datos['id_marca']."&funcion=B'><img src='../../img/borrar (3).png' alt=''></a>
  ...
  <a href='marca2.php?id_marca=0&funcion=A' ><img src='../../img/pluss.png ' class="m-2" height="50px" ></a>
  </table>
  </div></div>
</body>
<?php
